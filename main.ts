namespace SpriteKind {
    ...
    export const NPC_CAT = SpriteKind.create()
    export const npc_cat2 = SpriteKind.create()
    export const npc_cat3 = SpriteKind.create()
}
...
sprites.onDestroyed(SpriteKind.NPC_CAT, function (sprite) {
    NPC1_2 = sprites.create(img`
        e e e . . . . e e e . . . . 
        c d d c . . c d d c . . . . 
        c b d d f f d d b c . . . . 
        c 3 b d d b d b 3 c . . . . 
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.NPC_CAT, function (sprite, otherSprite) {
    NPC1.say("Hi! I need help, Come:)", 2000)
    pause(2500)
    NPC1.setVelocity(111, 0)
    pause(2000)
    NPC1.destroy()
})
...
sprites.onDestroyed(SpriteKind.npc_cat2, function (sprite) {
    npc_cat_1_3 = sprites.create(img`
        e e e . . . . e e e . . . . 
        c d d c . . c d d c . . . . 
        c b d d f f d d b c . . . . 
        c 3 b d d b d b 3 c . . . . 
        ...
        . f f . . f f . . f f . . . 
        `, SpriteKind.npc_cat3)
    npc_cat_1_3.setPosition(350, 55)
    first_enemy = sprites.create(img`
        ........................
        ........................
        ........................
        ........................
        ...
        ........................
        `, SpriteKind.Enemy)
    first_enemy.setPosition(450, 55)
    first_enemy.follow(player1, 50)
    statusbar = statusbars.create(20, 4, StatusBarKind.EnemyHealth)
    statusbar.setColor(9, 2)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.npc_cat2, function (sprite, otherSprite) {
    NPC1_2.say("Now i need help. My friend has kidnapped by ghost!")
    pause(6000)
    NPC1_2.destroy()
})
sprites.onDestroyed(SpriteKind.Enemy, function (sprite) {
    npc_cat_1_3.follow(player1, 100)
...
let first_enemy: Sprite = null
let npc_cat_1_3: Sprite = null
let NPC1_2: Sprite = null
